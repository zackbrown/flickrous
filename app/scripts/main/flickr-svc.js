  ...
  .factory('flickr', function (config, $http) {
    ...
    return {
      ...
      getPhoto = function(photoInfo){
        ...
        return {url: url, promise: $http.get(url)};
      }
    };
  });
